...
_private.deserialize = function deserialize(obj) {
    try {
        return {
            id: obj.id,
            message: obj.detail || obj['error_description'],
            statusCode: obj.status,
            code: obj.code || obj.error,
            level: obj.meta.level,
            help: obj.meta.help,
            context: obj.meta.context
        };
    } catch (err) {
        return {
...
_private.OAuthSerialize = function OAuthSerialize(err) {
    ...
    }, _.omit(_private.serialize(err), ['detail', 'code']));
};
...
_private.JSONAPIDeserialize = function JSONAPIDeserialize(errorFormat) {
    ...
    var internalError = new this[errorFormat.title || errorFormat.name || this.InternalServerError.name](_private.deserialize(errorFormat));
 ...
 *   format: jsonapi || oauth
 */
exports.deserialize = function deserialize(errorFormat, options) {
    options = options || {format: 'jsonapi'};
